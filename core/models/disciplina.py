...
class Disciplina(TimeStampedModel):
    ...
    carga_horaria_semanal = models.PositiveIntegerField(validators=[MinValueValidator(1)])
    horas_a_serem_alocadas = models.PositiveIntegerField(validators=[MinValueValidator(1)])
